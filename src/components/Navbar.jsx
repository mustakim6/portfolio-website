...
const Navbar = () => {
  return (
    <nav className=" bg-black/20 hover:bg-black/60  w-full p-4 md:px-10  md:flex md:justify-between md:items-center rounded-xl sticky top-0 z-50 hover:shadow-[0_0_20px_2px_rgba(30,58,138,0.8)] hover:my-1 ">
